...
class FarmController extends Controller
{
    private const MODULES = [
        ...
        'regions' => [FarmRegion::class, ['farm_id'=>['required','integer','exists:farms,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'description'=>['nullable','string'], 'area_hectares'=>['numeric','min:0']]],
        'fields' => [FarmField::class, ['farm_id'=>['required','integer','exists:farms,id'], 'region_id'=>['nullable','integer','exists:farm_regions,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'area_hectares'=>['numeric','min:0'], 'soil_type'=>['nullable','string'], 'status'=>['sometimes','string']]],
        'blocks' => [FarmBlock::class, ['field_id'=>['required','integer','exists:farm_fields,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'area_hectares'=>['numeric','min:0'], 'crop'=>['nullable','string'], 'variety'=>['nullable','string'], 'status'=>['sometimes','string']]],
        'greenhouses' => [Greenhouse::class, ['farm_id'=>['required','integer','exists:farms,id'], 'field_id'=>['nullable','integer','exists:farm_fields,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'area_square_meters'=>['numeric','min:0'], 'structure_type'=>['nullable','string'], 'climate_control'=>['nullable','string'], 'status'=>['sometimes','string']]],
        'irrigation-zones' => [IrrigationZone::class, ['farm_id'=>['required','integer','exists:farms,id'], 'field_id'=>['nullable','integer','exists:farm_fields,id'], 'block_id'=>['nullable','integer','exists:farm_blocks,id'], 'greenhouse_id'=>['nullable','integer','exists:greenhouses,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'method'=>['nullable','string'], 'flow_rate_lph'=>['nullable','numeric','min:0'], 'status'=>['sometimes','string']]],
        ...
        'gis-maps' => [GisMap::class, ['farm_id'=>['nullable','integer','exists:farms,id'], 'name'=>['required','string','max:255'], 'layer_type'=>['required','string','max:64'], 'source_url'=>['nullable','url'], 'geojson'=>['nullable','array'], 'metadata'=>['nullable','array']]],
    ];
