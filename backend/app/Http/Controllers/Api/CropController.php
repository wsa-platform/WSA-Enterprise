...
class CropController extends Controller
{
    ...
    private const MODULES = [
        ...
        'seasons' => [CropSeason::class, ['farm_id'=>['nullable','integer','exists:farms,id'], 'code'=>['required','string','max:32'], 'name'=>['required','string','max:255'], 'starts_at'=>['required','date'], 'ends_at'=>['nullable','date','after_or_equal:starts_at'], 'status'=>['sometimes','string']], ['farm_id'=>Farm::class]],
        'growth-stages' => [GrowthStage::class, ['crop_type_id'=>['nullable','integer','exists:crop_types,id'], 'name'=>['required','string','max:255'], 'sequence'=>['sometimes','integer','min:0'], 'expected_days'=>['nullable','integer','min:0'], 'description'=>['nullable','string']], ['crop_type_id'=>CropType::class]],
