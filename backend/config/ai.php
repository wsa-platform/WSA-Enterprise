...
return [
    ...
    */
    ...
    'embeddings' => [
        ...
        'dimensions' => env('AI_EMBEDDING_DIMENSIONS') === null || env('AI_EMBEDDING_DIMENSIONS') === ''
            ? null
            : (int) env('AI_EMBEDDING_DIMENSIONS'),
        'distance_metric' => env('AI_EMBEDDING_DISTANCE_METRIC', 'cosine'),
        'ann_enabled' => filter_var(env('AI_EMBEDDING_ANN_ENABLED', true), FILTER_VALIDATE_BOOL),
