...
const arOverlay = {
  newsletter: {
    ...
    description: 'أخبار زراعية ومقالات جديدة ونصائح للمزارعين وتحديثات المنصة وأبرز عروض المتجر.',
  ...
  sections: {
    ornamentalPlants: {
      title: 'نباتات الزينة',
      description: 'نباتات زينة داخلية وخارجية ونباتات مزهرة وشجيرات حدائق ونباتات تزيينية.',
      imageAlt: 'زهور زينة ملونة ونباتات حديقة',
    },
    hydroponicAquaculture: {
      title: 'الزراعة الهيدروبونك والزراعة المائية',
      description: 'زراعة هيدروبونية حديثة وزراعة مائية — أنظمة زراعية مستدامة قائمة على المياه.',
      imageAlt: 'نباتات هيدروبونية في بيوت محمية حديثة',
    },
    smallProjects: {
      title: 'مشاريع صغيرة',
    ...
    'ornamentalPlants.features.indoor': { title: 'نباتات زينة داخلية', body: 'نباتات منزلية زينة وخضرة داخلية.' },
    'ornamentalPlants.features.outdoor': { title: 'نباتات زينة خارجية', body: 'أسرة حدائق وشرفات ونباتات تنسيق الحدائق.' },
    ...
    'hydroponicAquaculture.features.hydroponic': { title: 'زراعة هيدروبونية', body: 'أنظمة زراعة بدون تربة للإنتاج الحديث.' },
    ...
    'smallProjects.features.business': { title: 'مشاريع أعمال زراعية صغيرة', body: 'إرشادات جدوى للمشاريع الزراعية المصغرة.' },
  },
  highlights: {
    ornamentalPlants: {
      shrubs: { title: 'شجيرات زينة', body: 'شجيرات زينة للحدائق والمناظر الطبيعية.' },
      decorative: { title: 'نباتات زينة', body: 'مجموعات زينة للمنازل والحدائق.' },
    },
    hydroponicAquaculture: {
      water: { title: 'أنظمة مائية', body: 'نهج متكامل للهيدروبونية والزراعة المائية.' },
