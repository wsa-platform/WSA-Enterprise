/** ISO 3166-1 alpha-2 codes accepted by the marketplace listing API. */
export const MARKETPLACE_COUNTRY_CODES = [
...
export function countryDisplayName(code: string | null | undefined, language: string): string {
  if (!code) return ''
