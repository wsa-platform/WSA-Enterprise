...
class SidebarNav extends StatelessWidget {
  ...
  static const _primaryDestinations = <NavDestination>[
    NavDestination(
      ...
      anyPermissions: ['platform.access', 'platform.reports.view'],
    ),
    NavDestination(
    ...
    NavDestination(
      ...
      anyPermissions: ['platform.organizations.view'],
    ),
    NavDestination(
      path: AppRoutes.communications,
      label: Ar.navCommunications,
      icon: Icons.forum_outlined,
      permission: 'platform.legacy.hidden',
    ),
    NavDestination(
    ...
    NavDestination(
      ...
      anyPermissions: ['platform.jobs.view', 'platform.jobs.manage'],
    ),
    NavDestination(
      path: AppRoutes.marketplace,
      label: Ar.navMarketplace,
      icon: Icons.storefront_outlined,
      anyPermissions: ['platform.marketplace.view', 'platform.marketplace.manage'],
    ),
    NavDestination(
  ...
  static const _secondaryDestinations = <NavDestination>[
    ...
    NavDestination(
      ...
      anyPermissions: ['platform.library.view', 'platform.library.manage'],
    ),
    NavDestination(
    ...
    NavDestination(
      ...
      anyPermissions: ['platform.monitoring.view'],
    ),
  ];
