...
- Phase 12 M12.2 adds GHCR push and deploy automation; M12.3 adds secrets templates.

See also [deployment.md](deployment.md), [tls-production.md](tls-production.md), and [testing.md](testing.md).
