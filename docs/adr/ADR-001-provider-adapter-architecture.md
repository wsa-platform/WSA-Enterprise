...
**الحالة:** ACCEPTED / IMPLEMENTED — معتمد / منفَّذ  
...
**حالة التنفيذ:** IMPLEMENTED — تم التنفيذ  
...
**ACCEPTED / IMPLEMENTED — معتمد / منفَّذ**
...
# 45. Implementation notes (as of 2026-09-09)

Concrete implementation landed on branch `phase-18-m18-ai-marketing-communications` under `App\Services\Agriculture\Intelligence\`. This section records implementation-specific facts from that work; it does not change the architectural decision above.

## 45.1 Implementation decisions

1. Provider/adapter architecture under `App\Services\Agriculture\Intelligence\` with:
...
## 45.2 Consequences (implementation)
